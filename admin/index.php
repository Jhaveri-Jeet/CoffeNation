...
$sql = "SELECT Reservations.Id, Tables.TableNumber,Tables.Id as TableId, Reservations.Date, Tables.Status,Customer.Name FROM Reservations INNER JOIN Tables ON Tables.Id = Reservations.TableId INNER JOIN Customer ON Customer.Id = Reservations.CustomerId WHERE Tables.Status = 'NotOccupied'";
        ...
        <div class="col-lg-12 d-flex align-items-stretch">
            <div class="card w-100">
                <div class="card-body p-4">
                    <div class="row">
                        <h5 class="card-title fw-semibold mb-4 col">All Pending Reservations
                        </h5>
                    </div>
                            ...
                            <tbody>
                                <?php for ($i = 0; $i < count($data); $i++) { ?>
                                    <tr>
                                        ...
                                        <td class="border-bottom-0">
                                            <a class="mb-0 fw-normal align-middle" onclick="showUpdateModal(<?= $data[$i][2] ?>, '<?= $data[$i][3] ?>')">
